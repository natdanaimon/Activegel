...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="set_mail.php"><?= $_SESSION[set_cmail] ?></a>
                                </li>
                            </ul>
                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            <div class="caption font-green">
                                                ...
                                                <span class="caption-subject bold uppercase"> <?= $_SESSION[tt_detail_cmail] ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                <input type="text" class="form-control bold" id="s_insurance" name="s_insurance">
                                                <label for="form_control_1"><?= $_SESSION[lb_setMail_insurnce] ?> <span class="required">*</span></label>          
                                            </div>
                                            <div class="form-group form-md-line-input has-success">
                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet-body form">
                                            <div class="form-actions noborder">
                                                <a href="set_mail.php"> <button type="button" class="btn default"><?= $_SESSION[btn_cancel] ?></button></a>
        ...
        <script src="js/action/setting/email.js" type="text/javascript"></script>
