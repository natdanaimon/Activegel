                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase"><?= $_SESSION[tt_mg_user] ?></span>
                                        </div>
                                        <div class="actions">
                                        ...
                                        <div class="table-toolbar">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" align="left"  <?= $hidden ?>>
                                                    <div class="btn-group">
                                                        <a href="emp_userManage.php?func=add">
...
<!--        <script src="../assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>-->
        ...
        <script src="js/action/employee/emp_user.js" type="text/javascript"></script>
        <script>
