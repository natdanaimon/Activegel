...
function initialDataTable(first) {
    $.ajax({
        type: 'GET',
        url: 'controller/setting/partnerController.php?func=dataTable',
        beforeSend: function ()
        {
        ...
        success: function (data) {
            ...
            $.each(res, function (i, item) {
                ...
                col_checkbox += '  value="' + item.i_part_comp + '" onclick=remove_select_all("checkbox_' + i + '")>';
                ...
                col_edit += '<a href="set_compPartnerManage.php?func=edit&id=' + item.i_part_comp + '" class="btn btn-circle btn-icon-only blue">';
...
$(document).on('click', '.notifyjs-foo-base .notify-yes', function () {
    ...
    $.ajax({
        type: 'GET',
        url: 'controller/setting/partnerController.php?func=' + func + '&id=' + id,
        beforeSend: function ()
        {
            $('#se-pre-con').fadeIn(100);
        },
